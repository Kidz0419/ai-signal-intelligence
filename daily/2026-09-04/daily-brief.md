...
**窗口：** 北京时间 2026-08-31 16:34 至 2026-09-04 00:34  
...
- 主注册信源连通性状态：not_checked 85（仅可访问、未解析内容变化）、access_blocked 5、mechanical_failure 21。
...
**判断：** 不为数量降标，继续等同日后续窗口。  
**覆盖：** not_checked 85，access_blocked 5，mechanical_failure 21；日期解析探针 checked_no_match 14。  
