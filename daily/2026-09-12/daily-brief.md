...
**窗口：** 北京时间 2026-09-08 16:15 至 2026-09-12 00:15  
...
- 主注册信源连通性状态：not_checked 93（仅可访问、未解析内容变化）、access_blocked 7、mechanical_failure 11。
- 日期解析探针状态：checked_no_match 10、candidate_only 18。
...
**判断：** 不为数量降标，继续等同日后续窗口。  
**覆盖：** not_checked 93，access_blocked 7，mechanical_failure 11；日期解析探针 checked_no_match 10。  
