...
**窗口：** 北京时间 2026-08-30 16:01 至 2026-09-03 00:01  
...
- 主注册信源连通性状态：not_checked 98（仅可访问、未解析内容变化）、access_blocked 9、mechanical_failure 4。
...
**判断：** 不为数量降标，继续等同日后续窗口。  
**覆盖：** not_checked 98，access_blocked 9，mechanical_failure 4；日期解析探针 checked_no_match 15。  
