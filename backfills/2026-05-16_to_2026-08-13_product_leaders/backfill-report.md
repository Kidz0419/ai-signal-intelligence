...
- 日期由节目页、官方频道、RSS、Apple Podcasts 公开元数据或官方正文确认即可登记为 `backfill_candidate`。
- 没有逐字稿时只写标题、嘉宾身份、发布日期及节目方明确列出的主题，不补写具体观点、数据或方法。
- 视频、音频和跨平台版本按同一节目去重；同一人物多期重复主题在 `topic-clusters.json` 合并。
...
- **日期 / 人物 / 组织：** 2026-04-23｜Cat Wu｜Anthropic
- **证据层级：** `chapters`
- **可确认主题：** Anthropic 产品团队的交付节奏；PRD、路线图与 PM/工程角色变化；Claude Code 与 Cowork 的产品边界；Evals、产品品味与模型变化
- **边界：** Apple Podcasts 元数据给出完整 Show Notes、章节和逐字稿入口；当前公开逐字稿链接发生页面错配，因此本条只按章节证据使用，不引用未核验逐字稿内容。
- **来源：** https://podcasts.apple.com/us/podcast/how-anthropics-product-team-moves-faster-than-anyone/id1627920305?i=1000763270413

### 2. EP 15: Kevin Weil (OpenAI)
- **日期 / 人物 / 组织：** 2026-04-29｜Kevin Weil｜OpenAI
- **证据层级：** `show_notes`
- **可确认主题：** 科学家如何参与前沿模型研发；AI 进入科学家的日常工作流；AI 科学采用障碍、同行评审与人类专业判断
- **边界：** 节目说明注明录制于 2026-03-10、发布于 2026-04-29，且嘉宾随后已离开 OpenAI；本条按录制时身份登记，不代表发布时仍在任。
- **来源：** https://podcasts.apple.com/us/podcast/ep-15-kevin-weil-openai/id1838537611?i=1000764565840

### 3. Hey ChatGPT Chef, wie weit ist KI weg, die einfach für uns macht, Nick Turley? (#66)
- **日期 / 人物 / 组织：** 2026-05-12｜Nick Turley｜OpenAI
- **证据层级：** `show_notes`
- **可确认主题：** ChatGPT 从应答式产品走向主动执行助手；计算机操作与 Agent 产品方向；健康问题使用、产品界面和创业机会
- **边界：** 主题来自节目方公开 Show Notes、章节或演示说明；不等同于逐字稿，未公开细节不得外推。
- **来源：** https://podcasts.apple.com/us/podcast/hey-chatgpt-chef-wie-weit-ist-ki-weg-die-einfach-f%C3%BCr/id1510727410?i=1000767434909

### 4. Inside Anthropic: How Claude Actually Gets Built
- **日期 / 人物 / 组织：** 2026-05-17｜Alex Albert｜Anthropic
- **证据层级：** `chapters`
- **可确认主题：** 把新模型作为产品管理；用户反馈如何进入模型训练与能力优先级；Adaptive Thinking、Evals 与 Claude character；用 Cowork 压测产品文档
- **边界：** 主题来自节目方公开 Show Notes、章节或演示说明；不等同于逐字稿，未公开细节不得外推。
- **来源：** https://podcasts.apple.com/us/podcast/inside-anthropic-how-claude-actually-gets-built-alex/id1736359687?i=1000768251789

### 5. HTML is the new Markdown: How Anthropic engineers are building with Claude Code
- **日期 / 人物 / 组织：** 2026-05-18｜Thariq Shihipar｜Anthropic
- **证据层级：** `chapters`
- **可确认主题：** 使用 HTML artifact 进行规划、交互原型与沟通；可编辑微型 UI 与代码库内设计系统；给予模型灵活性同时保持人类在环
- **边界：** 主题来自节目方公开 Show Notes、章节或演示说明；不等同于逐字稿，未公开细节不得外推。
- **来源：** https://podcasts.apple.com/us/podcast/html-is-the-new-markdown-how-anthropic-engineers-are/id1809663079?i=1000768383813

### 6. The Gemini app becomes more agentic, delivering proactive, 24/7 help
- **日期 / 人物 / 组织：** 2026-05-19｜Josh Woodward｜Google
- **证据层级：** `full_text`
- **可确认主题：** Gemini 3.5 Flash、Neural Expressive 与 Gemini Omni；Daily Brief 和 Gemini Spark 的主动式 Agent 产品形态；连接应用、MCP、后台运行与 macOS 路线；高风险动作事前确认和用户连接控制
- **边界：** Google 产品负责人署名官方正文，可核验功能、开放范围和授权边界；用户数、能力和效果属于 Google 官方自报，不能当作独立评测。
- **来源：** https://blog.google/innovation-and-ai/products/gemini-app/next-evolution-gemini-app/

### 7. Claude Code Head Boris Cherny: Insane Growth, Tokenmaxxing, AI Agents’ Next Frontier
- **日期 / 人物 / 组织：** 2026-05-20｜Boris Cherny｜Anthropic
- **证据层级：** `show_notes`
- **可确认主题：** Claude Code 增长与 Agent 可持续性；大量并行 Agent、Token 限制和下一阶段；Codex 竞争、SaaS 变化和自改进系统
- **边界：** 主题来自节目方公开 Show Notes、章节或演示说明；不等同于逐字稿，未公开细节不得外推。
- **来源：** https://podcasts.apple.com/us/podcast/claude-code-head-boris-cherny-insane-growth-tokenmaxxing/id1522960417?i=1000768721139

### 8. Inside Google’s Creative Frontier with Josh Woodward & Robert Wong
- **日期 / 人物 / 组织：** 2026-05-21｜Josh Woodward｜Google
- **证据层级：** `chapters`
- **可确认主题：** Google Flow 的产品形成过程；Gemini 与创意产品的“almost possible”边界；降低用户恐惧、创意与人类判断；AI 创意工具的限制与评估
- **边界：** 主题来自节目方公开 Show Notes、章节或演示说明；不等同于逐字稿，未公开细节不得外推。
...
- **证据层级：** `show_notes`
- **可确认主题：** AWS Agentic AI 产品与企业平台；企业 Agent 的上下文整合；AI 软件开发中的速度、安全与可信执行
...
- **证据层级：** `chapters`
- **可确认主题：** Claude Code 产品构建方式；Capability overhang、Harness Engineering 与 Evals；Plan Mode、RAG 和提示实践；AI 如何改变产品团队与创始人决策
- **边界：** 主题来自节目方公开 Show Notes、章节或演示说明；不等同于逐字稿，未公开细节不得外推。
...
- **边界：** 节目标题含“950M monthly users”，但 Show Notes 没有定义统计对象、口径或时间点；本回溯只把它保留为标题层厂商/节目方表述，不当作已核验用户数据。
- **来源：** https://podcasts.apple.com/us/podcast/josh-woodward-vp-google-labs-gemini-ai-studio-building/id1510330391?i=1000783000701

## 覆盖缺口

- **YouTube transcripts：** runtime IP / anti-bot limited；多数公开视频无法稳定取得逐字稿。 替代：YouTube 页面源码日期、节目 RSS、Apple Podcasts 元数据、节目官网 Show Notes。
- **X official API：** no app/OAuth configured；无法系统回溯产品负责人的 X 长文和线程。 替代：个人博客、官方署名正文、公开节目页和 RSS。
- **Spotify and closed podcast platforms：** partial；无公开 RSS 或登录墙节目覆盖不完整。 替代：Apple Podcasts Search API、节目官网和官方 YouTube。
- **Microsoft AI / Meta AI / Cursor / xAI product leaders：** no strict date-confirmed candidate found in this pass；不能把 0 解释为近期没有内容，只能解释为本轮公开源未召回严格候选。 替代：后续继续按人物注册表定向扫描。
